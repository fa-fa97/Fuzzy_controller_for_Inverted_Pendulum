...
class Cart:
    ...
    def simulate(self):
        print("x:{} x_dot:{} x_dot_dot:{} theta:{} theta_dot:{} theta_dot_dot:{}"
               .format(self.x, self.x_dot, self.x_dot_dot, (degrees(self.theta)-180.0)/-180.0, self.theta_dot/-9.0, self.theta_dot_dot))
    ...
    def control(self):
        self.input["theta"] = (degrees(self.theta)-180.0)/-180.0
        self.input["theta_dot"] = self.theta_dot/-9.0
